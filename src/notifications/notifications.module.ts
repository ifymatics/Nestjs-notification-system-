...
@Module({
  ...
  imports: [MongooseModule.forRoot('mongodb://root:pass12345@mongodb:27017/notification-system?serverSelectionTimeoutMS=2000&authSource=admin'), ChannelFactoryModule],
